...
const SHELL = ['./', './index.html', './styles.css', './boot.js', './app.js', './core.js', './auth.js', './data.js', './ui.js', './owner.js', './staffview.js', './breaks.js', './tickets.js', './manager.js', './notify.js', './pdf.js', './firebase-config.js', './archivo-latin.woff2', './icon.svg', './icon-192.png', './icon-512.png', './manifest.webmanifest'];
